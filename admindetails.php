 ...
 <html>
    ...
    <body>
        <div class="glass">
            ...
            <ul>
                <li><a href="admindetails.php" class="active">Dashboard</a></li><br>
                ...
                <div class="card2">
                    <table align="center" cellpadding="6" width="80%"> 
                        <tr>
                                <td colspan="1"><b><font size="6">Hello Admin,Dashboard</font></b></td>
                        </tr>
                        </table><hr>
                            <div class="glass1">
                                 <p class="p1"><b><?php echo $h1 ?></b></p>
                                 <p class="p2" style='color:black'>Total Staff     
