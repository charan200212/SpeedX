                ...
                <div class="glass">
                      <div class="box">
                                <img src="pic/log1.png" width="200px" height="150px"/>
                                 <ul>
                                    <li><a href="userdetails.php">Dashboard</a></li><br>
                                    <li><a href="usercourierdetails.php" class="active"> Delivery Details</a></li><br>
                ...
                <li><a href="logout.php">logout</a></li><br>
                            ...
                            <div class="box2">
                                <table align="center" class="abc" cellpadding="6" width="80%"> 
                                    <tr>
                                            <td colspan="1"><b><font size="6">Hello Employee, Deliveried Details</font></b></td>
                                    </tr>
                                    </table><hr>
                                        <div class="tabel1">
                                                ...
                                                <thead class="thead-dark">
                                                    ...
                                                    <tbody>
                                                            ...
                                                            <tr class="table-light">
                                                                ...
                                                                <td> <a href="update.php?id=<?php echo$row['parcel_id'];?>"><i class="fa fa-pencil-square-o"></i></a></td>
                                                                <td> <a href="delete.php?id=<?php echo$row['parcel_id'];?>"><i class="fa fa-trash"></i></a></td>
                                                            </tr>
                                                        <?php } ?>     
                                                    </tbody>   
                                                </tabel>
