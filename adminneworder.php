                      ...
                      <div class="box">
                                <img src="pic/log1.png" width="200px" height="150px"/>
                                 <ul>
                                    ...
                                    <li><a href="adminorderdetails.php" class="active">Details</a></li><br>
                            ...
                            <div class="box2">
                                <table align="center" class="abc" cellpadding="6" width="80%"> 
                                    <tr>
                                        ...
                                        <div class="tabel1">  
                                        <form action="adminnewdetails.php" method="POST">
                                            <?php include( 'Database\condatabase.php');
                                            $query = mysqli_query($con, "select *from courier ")?>
                                            <label>ID</label>
                                             <input type="text" name="parcel_id" required/><br>
                                            <label>NAME</label>
                                             <input type="text" name="coustmer_name" required/><br>
                                            <label>FROM</label>
                                             <input type="text" name="parcel_from"required/><br>
                                             <label>TO</label>
                                             <input type="text" name="parcel_to"required/><br>
                                            <label>FROM-DATE</label>
                                             <input type="date" name="from_date"required/><br>
                                            <label>DELIVERY-DATE</label>
                                             <input type="date" name="delivery_date"required/><br>
                                            <label>WHOM</label>
                                             <input type="text" name="parcel_whom"required/><br>
                                            <label>PARCEL-AMOUNT</label>
                                             <input type="text" name="parcel_amount"required/><br>
                                            <label>COUSTOMER-NUMBER</label>
                                             <input type="text" name="coustmer_number" maxlength="10"required/><br>
                                            <label>EMAIL</label>
                                             <input type="text" name="email"required/><br>
                                            <label>PARCEL-STATUS</label>
                                             <input type="text" name="parcel_status"required/><br><br>
